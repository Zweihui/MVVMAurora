...
import com.jess.arms.mvvm.IViewModel;
 ...
 * ================================================
 */
public abstract class BaseActivity<DB extends ViewDataBinding, VM extends IViewModel> extends AppCompatActivity implements IActivity, ActivityLifecycleable,HasSupportFragmentInjector {
